...
Writes ARCHITECTURE.md explaining every component and evidence derivation.
"""
...
_DOC_PATH = os.path.join(config.REPORTS_DIR, "ARCHITECTURE.md")
...
def generate_documentation():
    content = _CONTENT.format(generated_at=now_iso())
