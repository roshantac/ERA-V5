...
This single command regenerates `artifacts/` from scratch and runs the complete pipeline end-to-end.
...
Tests read only from generated artifacts. Run via `run_demo.py` (embedded at the end of the pipeline). Results in `artifacts/tests/test_report.json`.
